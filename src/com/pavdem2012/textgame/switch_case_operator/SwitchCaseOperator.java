...
public class SwitchCaseOperator {
    ...
    /**
     * Дано название месяца прописью, вывести его порядковый номер. Если в названии
     * месяца есть ошибка, то вывести "Ошибка". Регистр букв и наличие пробелов в
     * начале или конце не должны влиять на работу программы.
     * 
     * @param inputText this is text for processing
     * @return either a message about the ordinal number of the month, or an error
     *         message
     */
